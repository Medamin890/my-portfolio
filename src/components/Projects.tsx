  ...
  const projects = [
    {
      ...
      image: dhashbordIMG,
      technologies: ['React.js', 'Spring Boot', 'MySQL', 'AntDesign'],
    ...
    },
    {
      ...
      image: techstoreimg ,
      technologies: ['React.js', 'Node.js', 'Express', 'MongoDB' ,'tailwind css','Stripe'],
      category: 'Web Application',
      icon: Globe,
      github: 'https://github.com/Medamin890/EcommerceProject-frontend',
      live: '#',
      featured: true,
